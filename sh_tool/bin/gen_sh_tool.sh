...
declare -A GEN_SH_TOOL_LOGO_DATA=(
    [OWNER]="vroncevic"
    [REPO]="${GEN_SH_TOOL_TOOL}"
    [VERSION]="${GEN_SH_TOOL_VERSION}"
    [LOGO]="${GEN_SH_TOOL_LOGO}"
)
...
function __gen_sh_tool {
    ...
    display_logo GEN_SH_TOOL_LOGO_DATA
